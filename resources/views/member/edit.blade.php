    ...
    <form class="form-horizontal" action="{{route('member.update', $members->id)}}" method="post">
        ...
        <div class="box-body">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" name="NIP" class="form-control" id="NIP" placeholder="NIP" value="{{$members->NIP}}">
                </div>
            </div>
            <div class="form-group">
                <label for="name" class="col-sm-2 control-label">Name Members</label>
                <div class="col-sm-10">
                    <input type="text" name="name" class="form-control" id="name" placeholder="Name Members" value="{{$members->name}}">
                </div>
            </div>
            <div class="form-group">
                <label for="alamat" class="col-sm-2 control-label">Alamat Members</label>
                <div class="col-sm-10">
                    <input type="text" name="alamat" class="form-control" id="alamat" placeholder="Alamat Members" value="{{$members->alamat}}">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select class="form-control" name="status_id" >
                        ...
                        <option class="col-sm-10" value="{{$status->id}}" {{$members->status_id == $status->id ? 'selected' : ''}}>{{$status->name}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" name="no_telp" class="form-control" id="no_telp" placeholder="Nomor Telepon" value="{{$members->no_telp}}">
                </div>
            </div>
        </div>
